...
QT_INIT_METAOBJECT const QMetaObject cm::models::ClientTests::staticMetaObject = { {
    &TestSuite::staticMetaObject,
    qt_meta_stringdata_cm__models__ClientTests.data,
    qt_meta_data_cm__models__ClientTests,
    qt_static_metacall,
    nullptr,
    nullptr
} };
