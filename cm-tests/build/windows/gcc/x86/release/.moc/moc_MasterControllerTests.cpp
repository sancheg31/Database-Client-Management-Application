...
QT_INIT_METAOBJECT const QMetaObject cm::controllers::MasterControllerTests::staticMetaObject = { {
    &TestSuite::staticMetaObject,
    qt_meta_stringdata_cm__controllers__MasterControllerTests.data,
    qt_meta_data_cm__controllers__MasterControllerTests,
    qt_static_metacall,
    nullptr,
    nullptr
} };
