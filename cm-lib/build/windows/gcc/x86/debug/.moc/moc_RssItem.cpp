/****************************************************************************
** Meta object code from reading C++ file 'RssItem.h'
**
...
#include "../../../../../../source/rss/RssItem.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'RssItem.h' doesn't include <QObject>."
...
void cm::rss::RssItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<RssItem *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cm::rss::RssItem::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_cm__rss__RssItem.data,
    qt_meta_data_cm__rss__RssItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
