...
QT_INIT_METAOBJECT const QMetaObject cm::models::ClientSearch::staticMetaObject = { {
    &data::Entity::staticMetaObject,
    qt_meta_stringdata_cm__models__ClientSearch.data,
    qt_meta_data_cm__models__ClientSearch,
    qt_static_metacall,
    nullptr,
    nullptr
} };
