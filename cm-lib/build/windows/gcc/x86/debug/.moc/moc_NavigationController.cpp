...
QT_INIT_METAOBJECT const QMetaObject cm::controllers::NavigationController::staticMetaObject = { {
    &INavigationController::staticMetaObject,
    qt_meta_stringdata_cm__controllers__NavigationController.data,
    qt_meta_data_cm__controllers__NavigationController,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *cm::controllers::NavigationController::qt_metacast(const char *_clname)
{
    ...
    return INavigationController::qt_metacast(_clname);
}

int cm::controllers::NavigationController::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = INavigationController::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
