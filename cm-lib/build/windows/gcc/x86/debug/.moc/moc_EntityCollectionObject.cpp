/****************************************************************************
** Meta object code from reading C++ file 'EntityCollectionObject.h'
**
...
#include "../../../../../../source/data/EntityCollectionObject.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'EntityCollectionObject.h' doesn't include <QObject>."
...
void cm::data::EntityCollectionObject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<EntityCollectionObject *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (EntityCollectionObject::*)();
...
QT_INIT_METAOBJECT const QMetaObject cm::data::EntityCollectionObject::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_cm__data__EntityCollectionObject.data,
    qt_meta_data_cm__data__EntityCollectionObject,
    qt_static_metacall,
    nullptr,
    nullptr
} };
