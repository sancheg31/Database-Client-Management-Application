...
QT_INIT_METAOBJECT const QMetaObject cm::models::Appointment::staticMetaObject = { {
    &data::Entity::staticMetaObject,
    qt_meta_stringdata_cm__models__Appointment.data,
    qt_meta_data_cm__models__Appointment,
    qt_static_metacall,
    nullptr,
    nullptr
} };
