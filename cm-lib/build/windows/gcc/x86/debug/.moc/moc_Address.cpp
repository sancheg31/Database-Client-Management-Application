...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_cm__models__Address_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cm__models__Address_t qt_meta_stringdata_cm__models__Address = {
    {
QT_MOC_LITERAL(0, 0, 19), // "cm::models::Address"
QT_MOC_LITERAL(1, 20, 11), // "ui_building"
QT_MOC_LITERAL(2, 32, 26), // "cm::data::StringDecorator*"
QT_MOC_LITERAL(3, 59, 9), // "ui_street"
QT_MOC_LITERAL(4, 69, 7), // "ui_city"
QT_MOC_LITERAL(5, 77, 11), // "ui_postcode"
QT_MOC_LITERAL(6, 89, 14) // "ui_fullAddress"
...
QT_INIT_METAOBJECT const QMetaObject cm::models::Address::staticMetaObject = { {
    &data::Entity::staticMetaObject,
    qt_meta_stringdata_cm__models__Address.data,
