/****************************************************************************
** Meta object code from reading C++ file 'IWebRequest.h'
**
...
#include "../../../../../../source/networking/IWebRequest.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'IWebRequest.h' doesn't include <QObject>."
...
void cm::networking::IWebRequest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<IWebRequest *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (IWebRequest::*)(QString );
        ...
        {
            using _t = void (IWebRequest::*)(int , QByteArray );
...
QT_INIT_METAOBJECT const QMetaObject cm::networking::IWebRequest::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_cm__networking__IWebRequest.data,
    qt_meta_data_cm__networking__IWebRequest,
    qt_static_metacall,
    nullptr,
    nullptr
} };
